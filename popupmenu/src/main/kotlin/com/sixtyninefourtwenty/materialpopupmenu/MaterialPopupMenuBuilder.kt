...
class MaterialPopupMenuBuilder internal constructor(private val context: Context,
     ...
     *
     * You should use [R.style.Widget_MPM_Menu] or [R.style.Widget_MPM_Menu_Material3] for Material 2 or Material 3, respectively.
     *
    ...
    sealed class NormalItem : AbstractItem() {
        ...
        internal sealed class Data private constructor(val label: CharSequence?, val labelRes: Int) : AbstractItem.Data() {
    ...
    class NavBackItem private constructor(override val data: Data) : NormalItem() {
        ...
        internal class Data : NormalItem.Data {
            constructor() : super(R.string.go_back)
            constructor(label: CharSequence) : super(label)
            constructor(labelRes: Int) : super(labelRes)

            override var icon: Int = R.drawable.mpm_ic_menu_left
        }
    ...
    class RadioGroupItem internal constructor() : AbstractItem() {
        ...
        fun radioButtonItem(labelRes: Int, init: RadioButtonItem.() -> Unit) {
            data.radioButtonItems.add(RadioButtonItem(labelRes).apply(init).convertToPopupMenuItem())
        }
